...
3. **Probe the two open NPU constructor properties.** The fixed decode term (0.417 s, 65 % of a p50
...
4. **Parameterize source language** (T2.2) — Japanese-only by design. **Accept:** re-open only if the
   use-case expands.
