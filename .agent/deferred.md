...
3. **Price the EN lag behind every JA line.** The one live session (26 min, 143 captions, 143 of 143
...
5. **Re-derive the LID census from the committed corpora.** `tests/lid_census.json` is a reduction of
